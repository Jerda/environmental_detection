...
const admin = () => import('../components/admin/app.vue');
...

    {
        ...
        children: [
            ...
            },
            {
                path: 'wechat-user',
                name: 'wechat-user',
                component: wechat_user,
                meta: {adminAuth: true}
            },
            {
                path: 'wechat-config',
                name: 'wechat-config',
                component: wechat_config,
                meta: {adminAuth: true}
            },
            {
                path: 'wechat-menu',
                name: 'wechat-menu',
                component: wechat_menu,
                meta: {adminAuth: true}
            },
            {
                path: 'wechat-menu-add',
                name: 'wechat-menu-add',
                component: wechat_menu_add,
                meta: {adminAuth: true}
            },
            {
                path: 'wechat-material',
                name: 'wechat-material',
                component: wechat_material,
                meta: {adminAuth: true}
            },
            {
                path: 'wechat-material-add',
                name: 'wechat-material-add',
                component: wechat_material_add,
                meta: {adminAuth: true}
            },
            {
                path: 'factory/:id?',
            ...
            {
                path: 'factory/:farmer_id?',
                name: 'factory-by-farmer_id',
                component: factory,
                props: true,
                meta: {adminAuth: true}
            },
            ...
            {
                path: 'farmer/:worker_id?',
                name: 'farmer-by-worker',
                props: true,
                component: farmer,
                meta: {adminAuth: true}
            },
